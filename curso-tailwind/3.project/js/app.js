Vue.component('link-cascadia', {
    // colocar transiciones cuando se agrega un margen al hace hover no funciona
    // esta transition solo se aplica a ciertas propiedades de css, donde el margen no esta incluido.
    // Podemos usar la propiedad transition-all, que tiene incluye un mayor rango de propiedades donde esta el margin.
    template: `
...
Vue.component('panel-blog', {
    // esta es la card
    // Colocamos transition-shadow para las sombras
    template: `
...
// para los modos oscuro, claro y de sistema (sistema operativo)
new Vue({
    el: '#app',
